...
_AUDIENCE_DESCRIPTIONS: dict[Recipients, str] = {
    ...
    Recipients.CLASS_APPROVERS: "The Class Administrators (other admins can opt in).",
    Recipients.GUILD_LEADERSHIP_OR_CLASS_APPROVERS: (
        "The guild's lead and staff; for a lead-less category, the Class Administrators (other admins can opt in)."
    ),
    Recipients.SPACE_APPROVERS: "The Space & Cubby Administrators (other admins can opt in).",
    Recipients.DISCOUNT_APPROVERS: "The Discount Code Administrators (other admins can opt in).",
    Recipients.EVENTS_APPROVERS: "The Calendar Administrators (other admins can opt in).",
    Recipients.GUILD_LEADERSHIP_OR_EVENTS_APPROVERS: (
        "The guild's lead and staff; for a site-wide or council proposal, the Calendar Administrators "
        "(other admins can opt in)."
    ),
    Recipients.BILLING_APPROVERS: "The Billing Administrators (other admins can opt in).",
