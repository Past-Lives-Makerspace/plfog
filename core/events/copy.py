...
_CURATED: dict[str, EventCopy] = {
    ...
    "equipment.reservation_confirmed": EventCopy(
        # cancellation_policy is the late fee sentence when Site Settings carries a fee, and ""
        # otherwise (#408). Seeded copy already on prod is a DB row, so this default reaches
        # fresh copy only; an admin adds the line to live copy from the editor.
