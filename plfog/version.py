...
CHANGELOG: list[dict[str, str | list[str]]] = [
    ...
    },
    {
        "version": "1.60.0",
        "date": "2026-09-12",
        "title": "Every class has a price",
        "changes": [
            "The free class checkbox is gone from the class composer. Every class now needs a "
            "price of at least $1.00, from the instructor portal and the admin side alike.",
            "A registration whose total reaches $0 through a discount code or a member discount "
            "still completes without a payment step.",
        ],
    },
    {
        "version": "1.59.0",
    ...
    },
    {
        "version": "1.58.0",
        "date": "2026-09-12",
        "title": "Flyers and QR downloads unlock when a class is published",
        "changes": [
            "The printable flyer and the QR code downloads for a class are available once the "
            "class has been approved and published. Before that, the Share and Print card still "
            "shows the link and says when they unlock.",
            "A published class now has the Share and Print card on its edit page.",
        ],
    },
    {
        "version": "1.57.0",
    ...
    },
    {
        "version": "1.1.2",
        "date": "2026-08-17",
        "title": "All-day events show on the right day",
        "changes": [
            "All-day events (an all-day social, a work party, and the like) were showing up a day "
            "early on the calendar and in the Discord announcements. They now land on their correct "
            "date.",
        ],
    },
    {
