...
CHANGELOG: list[dict[str, str | list[str]]] = [
    {
        ...
        "changes": [
            ...
            "Random emails no longer trigger an outgoing 'no account found' message. The form still says 'we sent you a code' so a real person who mistypes won't be told whether the account exists, but nothing goes out unless the address actually matches a member. This alone takes almost all of the spam off the email bill.",
