...
def describe_orientation_booking():
    def it_lets_a_member_request_an_orientation(live_server, page, login_via_code):
        ...
        # 2. The guild page shows the orientation booking prompt for an un-oriented member.
        ...
        # 3. Request the open slot.
        page.locator('form[action*="/orientation/slots/"] button[type="submit"]').first.click()
