...
def describe_Notification():
    ...
    def it_marks_read():
        ...
        n = Notification.objects.create(user=user, trigger="class_reminder", title="t", body="b")
        n.mark_read()
        n.refresh_from_db()
    ...
    def it_str_includes_title_and_email():
        ...
        n = Notification.objects.create(user=user, trigger="class_reminder", title="New class", body="b")
...
def describe_NotificationPreference():
    def it_is_unique_per_user_event_and_channel():
        ...
        with pytest.raises(IntegrityError):
            NotificationPreference.objects.create(user=user, event_key="class_reminder", channel="email")
    ...
    def it_allows_distinct_channels_for_the_same_event():
        ...
        push = NotificationPreference.objects.create(
            user=user, event_key="class_reminder", channel="push", enabled=False
        )
